		...
		Tables: []AppwriteTable{
			...
			},
			{
				...
				Columns: []AppwriteColumn{
					...
					{Kind: "boolean", Key: "isArchived", Required: true},
					{Kind: "datetime", Key: "archivedAt", Required: false},
					{Kind: "integer", Key: "position", Required: true},
					{Kind: "datetime", Key: "createdAt", Required: true},
					{Kind: "datetime", Key: "updatedAt", Required: true},
				},
				Indexes: []AppwriteIndex{
					...
					{Key: "tasks_archived_order", Type: "key", Columns: []string{"boardId", "isArchived", "columnId", "archivedAt", "position"}, Orders: []string{"ASC", "ASC", "ASC", "ASC", "ASC"}},
				},
			},
		},
	}
