...
| `API-005` | Automated | `apps/apple/Sources/Todo/TodoMacOSTests/BoardViewModelTests.swift` (`moveTaskConflictSurfacesStatusDetails`), `internal/api/server/server_test.go` (`TestKanbanMoveTaskBetweenColumns`), `internal/api/server/server_test.go` (`TestKanbanMoveTaskReturnsBadRequestForOutOfRangePosition`), `internal/api/server/server_test.go` (`TestKanbanMoveTaskReturnsForbiddenForOtherOwner`), `internal/api/server/server_test.go` (`TestKanbanMoveTaskReturnsNotFoundForMissingDestinationColumn`), `internal/kanban/repository_contract_test.go` (`TestRepositoryContractMemoryService`), `internal/kanban/repository_contract_test.go` (`TestRepositoryContractSQLiteService`) | Covered | - |
...
| `PUBLIC-004` | Automated | `internal/api/server/server_test.go` (`TestOpenAPIDefinesKanbanPaths`) | Covered | - |
...
| `TASK-005` | Automated | `internal/api/server/server_test.go` (`TestKanbanMoveTaskBetweenColumns`), `internal/kanban/memory_repository_test.go` (`TestMemoryRepositoryCRUDAndReindex`), `internal/kanban/repository_contract_test.go` (`TestRepositoryContractMemoryService`), `internal/kanban/repository_contract_test.go` (`TestRepositoryContractSQLiteService`), `internal/kanban/service_test.go` (`TestServiceMoveTaskDelegates`), `internal/kanban/sqlite_repository_test.go` (`TestSQLiteRepositoryCRUDAndReindex`) | Covered | - |
| `TASK-006` | Automated | `internal/api/server/server_test.go` (`TestKanbanMoveTaskBetweenColumns`), `internal/kanban/memory_repository_test.go` (`TestMemoryRepositoryCRUDAndReindex`), `internal/kanban/repository_contract_test.go` (`TestRepositoryContractMemoryService`), `internal/kanban/repository_contract_test.go` (`TestRepositoryContractSQLiteService`), `internal/kanban/service_test.go` (`TestServiceMoveTaskRejectsNegativePosition`), `internal/kanban/sqlite_repository_test.go` (`TestSQLiteRepositoryCRUDAndReindex`) | Covered | - |
| `TASK-007` | Automated | `internal/api/server/server_test.go` (`TestKanbanMoveTaskBetweenColumns`), `internal/kanban/memory_repository_test.go` (`TestMemoryRepositoryCRUDAndReindex`), `internal/kanban/repository_contract_test.go` (`TestRepositoryContractMemoryService`), `internal/kanban/repository_contract_test.go` (`TestRepositoryContractSQLiteService`), `internal/kanban/sqlite_repository_test.go` (`TestSQLiteRepositoryCRUDAndReindex`) | Covered | - |
